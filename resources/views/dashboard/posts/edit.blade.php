  ...
  <div class="col-lg-8">
      <form action="/dashboard/posts/{{ $post->slug }}" method="POST"  class="mb-5" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control create-posts-title @error("title") is-invalid @enderror" id="title" name="title" value="{{ old("title", $post->title) }}" required autofocus>
          @error("title")
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control create-posts-slug @error("slug") is-invalid @enderror" id="slug" name="slug" value="{{ old("slug", $post->slug) }}" readonly>
          @error("slug")
          <div id="validationServer03Feedback" class="invalid-feedback">
              {{ $message }}
          </div>
